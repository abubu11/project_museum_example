...
describe('MuseumArtworkService', () => {
  ...
  it('addArtworkMuseum should add an artwork to a museum', async () => {
    ...
    const result: MuseumEntity = await service.addArtworkMuseum(
      newMuseum.id,
      newArtwork.id,
    );
  ...
  it('addArtworkMuseum should thrown exception for an invalid artwork', async () => {
    ...
    await expect(() =>
      service.addArtworkMuseum(newMuseum.id, '0'),
  ...
  it('addArtworkMuseum should throw an exception for an invalid museum', async () => {
    ...
    await expect(() =>
      service.addArtworkMuseum('0', newArtwork.id),
    ).rejects.toHaveProperty(
      'message',
  ...
  it('findArtworkByMuseumIdArtworkId should return artwork by museum', async () => {
    ...
    const storedArtwork: ArtworkEntity =
      await service.findArtworkByMuseumIdArtworkId(museum.id, artwork.id);
  ...
  it('findArtworkByMuseumIdArtworkId should throw an exception for an invalid artwork', async () => {
    await expect(() =>
      service.findArtworkByMuseumIdArtworkId(museum.id, '0'),
    ).rejects.toHaveProperty(
      'message',
      'The artwork with the given id was not found',
    );
  ...
  it('findArtworkByMuseumIdArtworkId should throw an exception for an invalid museum', async () => {
    const artwork: ArtworkEntity = artworksList[0];
    await expect(() =>
      service.findArtworkByMuseumIdArtworkId('0', artwork.id),
    ).rejects.toHaveProperty(
      'message',
      'The museum with the given id was not found',
    );
  ...
  it('findArtworkByMuseumIdArtworkId should throw an exception for an artwork not associated to the museum', async () => {
    ...
    await expect(() =>
      service.findArtworkByMuseumIdArtworkId(museum.id, newArtwork.id),
    ).rejects.toHaveProperty(
      'message',
  ...
  it('findArtworksByMuseumId should return artworks by museum', async () => {
    const artworks: ArtworkEntity[] = await service.findArtworksByMuseumId(
      museum.id,
    );
  ...
  it('findArtworksByMuseumId should throw an exception for an invalid museum', async () => {
    await expect(() =>
      service.findArtworksByMuseumId('0'),
    ).rejects.toHaveProperty(
      'message',
      'The museum with the given id was not found',
    );
  ...
  it('associateArtworksMuseum should update artworks list for a museum', async () => {
    ...
    const updatedMuseum: MuseumEntity = await service.associateArtworksMuseum(
      museum.id,
      [newArtwork],
    );
  ...
  it('associateArtworksMuseum should throw an exception for an invalid museum', async () => {
    ...
    await expect(() =>
      service.associateArtworksMuseum('0', [newArtwork]),
    ).rejects.toHaveProperty(
      'message',
      'The museum with the given id was not found',
    );
  ...
  it('associateArtworksMuseum should throw an exception for an invalid artwork', async () => {
    ...
    await expect(() =>
      service.associateArtworksMuseum(museum.id, [newArtwork]),
    ).rejects.toHaveProperty(
      'message',
      'The artwork with the given id was not found',
    );
  ...
  it('deleteArtworkToMuseum should remove an artwork from a museum', async () => {
    ...
    const storedMuseum: MuseumEntity = await museumRepository.findOne({
      where: { id: museum.id },
      relations: ['artworks'],
    });
    const deletedArtwork: ArtworkEntity = storedMuseum.artworks.find(
      (a) => a.id === artwork.id,
    );
  ...
  it('deleteArtworkToMuseum should thrown an exception for an invalid artwork', async () => {
    await expect(() =>
      service.deleteArtworkMuseum(museum.id, '0'),
    ).rejects.toHaveProperty(
      'message',
      'The artwork with the given id was not found',
    );
  ...
  it('deleteArtworkToMuseum should thrown an exception for an invalid museum', async () => {
    const artwork: ArtworkEntity = artworksList[0];
    await expect(() =>
      service.deleteArtworkMuseum('0', artwork.id),
    ).rejects.toHaveProperty(
      'message',
      'The museum with the given id was not found',
    );
  ...
  it('deleteArtworkToMuseum should thrown an exception for an non asocciated artwork', async () => {
    ...
    await expect(() =>
      service.deleteArtworkMuseum(museum.id, newArtwork.id),
    ).rejects.toHaveProperty(
      'message',
      'The artwork with the given id is not associated to the museum',
    );
